...
function ConfettiBurst() {
  ...
  return (
    <div style={{ position: 'absolute', inset: 0, overflow: 'hidden', borderRadius: 'var(--radius-lg)' }} aria-hidden="true">
      {pieces.map((p) => (
        <span
          key={p.id}
    ...
    <div className="modal-backdrop" role="dialog" aria-modal="true" aria-labelledby="success-title">
      <div className="modal-card">
        ...
        <p className="modal-message">
          {firstName ? <strong>{firstName}</strong> : 'You'} have been registered for the{' '}
